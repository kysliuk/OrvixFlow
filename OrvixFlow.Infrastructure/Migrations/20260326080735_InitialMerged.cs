        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DecisionDetails = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmbeddingVector = table.Column<Vector>(type: "vector", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Invitations_Tenants_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), new DateTime(2026, 3, 26, 8, 7, 33, 363, DateTimeKind.Utc).AddTicks(7073), "Doc-Intel", true, false, "doc-intel", "Utility", "UserFacing" },
                    { new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2026, 3, 26, 8, 7, 33, 364, DateTimeKind.Utc).AddTicks(3963), "Finance-Flow", true, false, "finance-flow", "Utility", "UserFacing" },
                    { new Guid("33333333-3333-3333-3333-333333333333"), new DateTime(2026, 3, 26, 8, 7, 33, 364, DateTimeKind.Utc).AddTicks(3984), "Inbox-Guardian", true, false, "inbox-guardian", "Utility", "UserFacing" },
                    { new Guid("44444444-4444-4444-4444-444444444444"), new DateTime(2026, 3, 26, 8, 7, 33, 364, DateTimeKind.Utc).AddTicks(4118), "Lead-Qualifier", true, false, "lead-qualifier", "Industry", "UserFacing" },
                    { new Guid("55555555-5555-5555-5555-555555555555"), new DateTime(2026, 3, 26, 8, 7, 33, 364, DateTimeKind.Utc).AddTicks(4124), "Legal-Scribe", true, false, "legal-scribe", "Industry", "UserFacing" },
                    { new Guid("66666666-6666-6666-6666-666666666666"), new DateTime(2026, 3, 26, 8, 7, 33, 364, DateTimeKind.Utc).AddTicks(4129), "Data-Guardian", true, false, "data-guardian", "Industry", "UserFacing" },
                    { new Guid("77777777-7777-7777-7777-777777777777"), new DateTime(2026, 3, 26, 8, 7, 33, 364, DateTimeKind.Utc).AddTicks(4162), "SOP-Generator", true, false, "sop-generator", "Industry", "UserFacing" },
                    { new Guid("88888888-8888-8888-8888-888888888888"), new DateTime(2026, 3, 26, 8, 7, 33, 364, DateTimeKind.Utc).AddTicks(4167), "Metered-Billing", true, true, "metered-billing", "Shadow", "Restricted" },
                    { new Guid("99999999-9999-9999-9999-999999999999"), new DateTime(2026, 3, 26, 8, 7, 33, 364, DateTimeKind.Utc).AddTicks(4173), "Audit-Log", true, true, "audit-log", "Shadow", "Restricted" }
                });
