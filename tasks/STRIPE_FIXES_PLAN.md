...
| Task | Status | Changes |
|------|--------|---------|
| T3-1: Idempotency Guard | ✅ Complete | StripeWebhookService.cs - duplicate invoice check |
| T3-2: Duplicate DI Removal | ✅ Complete | DependencyInjection.cs - removed duplicate registrations |
| T3-3: Invoice Storage | ✅ Complete | StripeWebhookService.cs - creates Invoice record on invoice.paid |
